import { LayoutDashboard, Users, UsersRound, Network, Activity, BarChart3, Settings, Lock } from 'lucide-react';
...
function Navbar() {
    ...
    const navItems: NavItem[] = [
        ...
        { path: '/families', label: t('nav.families', 'Families'), icon: UsersRound, priority: 'high' },
